...
//   const {posts,  loading, error, filters} = useSelector((state) => state.posts);

//   // Fetch posts on mount and when filters change
//   console.log('Redux State:', { posts, loading, error, filters });
//   useEffect(() => {
...
//   // Access Redux state
//   const { posts: apiPosts, loading, error, filters } = useSelector((state) => state.posts);
...
//     if (!apiPosts || !apiPosts.posts) return [];
    
//     return apiPosts.posts.map(post => ({
//       id: post._id,
//       title: post.title,
//       excerpt: post.content.substring(0, 150) + '...',
//       content: post.content,
//       author: post.author.name,
//       authorBio: "Author information", // Not in API
//       authorAvatar: "https://via.placeholder.com/100", // Placeholder
//       date: post.createdAt,
//       readTime: `${Math.ceil(post.content.length / 1000)} min read`, // Estimated
//       views: post.views || 0,
//       likes: 0, // Not in API
...
//       featured: false, // Not in API
//       trending: false, // Not in API
//       difficulty: "Beginner", // Not in API
//       rating: 4.5, // Not in API
//       premium: false // Not in API
//     }));
//   }, [apiPosts]);

//   // Extract all unique categories and tags from transformed posts
...
//       return matchesSearch && matchesCategory && matchesTags && matchesDate;
//     });
//   }, [transformedPosts, searchQuery, selectedCategories, selectedTags, dateRange]);
